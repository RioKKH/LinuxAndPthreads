 ...
 * キューを作る
 * @param sz 最大要素数
 * @return 作成したキューへのポインタ。キュー作成に失敗した場合はNULL
 */
 ...
 * @return 最大要素数
 */
extern size_t XYQueueSizeGetSize(XYQueue *que);
 ...
 * 要素を取り出す
 * @param que 対象キューへのポインタ
 * @param x 取り出したＸ座標値を格納する場所
 * @param y 取り出したＹ座標値を格納する場所
